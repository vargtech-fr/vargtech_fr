  ...
  return (
    <main className="max-w-4xl mx-auto p-4 pb-12 text-neutral-200 snap-start">
      ...
      <section className="mt-8">
        ...
        <p>
          Cette politique de confidentialité décrit la manière dont le site{" "}
          <strong>VargTech</strong> utilise et protège les informations
          concernant ses visiteurs. Elle concerne uniquement ce site web
      ...
      <section className="mt-8">
        <h2 className="text-lg font-semibold mb-2">
          3. Données collectées sur ce site
        </h2>
        <p>
          Ce site ne collecte pas directement de données personnelles. Aucune
          inscription, aucun formulaire et aucun cookie de suivi tiers ne sont
          utilisés.
        </p>
      </section>
      ...
      <section className="mt-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            ...
            est proposé. En cliquant sur ce lien, vous quittez ce site et êtes
            soumis à la{" "}
            <a
