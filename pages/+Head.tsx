...
export default function HeadDefault() {
  return (
    <>
      ...
      <meta
        property="og:title"
        content="VargTech — Le web au service des pros"
      />
      <meta
        property="og:description"
        content="Simple. Efficace. Rentable. Des outils pour votre métier."
      />
      <meta property="og:url" content="https://vargtech.fr/" />
      <meta
        property="og:image"
        content="https://vargtech.fr/assets/og/og-image-1200x630.jpg"
      />
